...
export const generateScreens = inngest.createFunction(
	...
	async ({ event, step, publish }) => {
      ...
      `;
        ...
        CRITICAL REQUIREMENTS A MUST - READ CAREFULLY:
        - **DO NOT BE LAZY.** Generate a full, detailed, premium landing page or screen. Include multiple sections, decorative elements, and complex Tailwind layouts.
        ...
        Generate a complete, complex, production-ready HTML for this screen now.
      `.trim(),
				});
